...
"""
Script to build nlohmann-json for RACE
"""
...
def get_cli_arguments():
    ...
    parser = builder.get_arg_parser("nlohmann-json", "3.10.5", 1, __file__)
...
if __name__ == "__main__":
    ...
    source_dir = os.path.join(args.source_dir, f"json-{args.version}")
